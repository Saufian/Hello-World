...
test = Screen(800, 200, (400, 400), 0, "Test")  # initialisation de GuerreEtCivilisation (résolution de l'affichage)
main = Screen(0, 0, (1300, 700), -1, "Base")
font = Screen(0, 0, Screen.main.get_rect()[2:], -1)

load_pygame_skin("Data/listeSkinLand.txt")  # récupération des skins dans le fichier dans data

toto = Perso("moi")  # création d'un personnage
toto.set_graphism(pygame.image.load("Data/Perso1_face1.png"))  # mise en place du skin
toto.set_coord(6, 7)  # positionnement

titi = Perso("perso 2")  # création d'un second personnage
titi.set_graphism(pygame.image.load("Data/Perso2_face1.png"))
titi.set_coord(3, 3)  # placement aux coordonnées (3, 3)

tata = Perso("perso 3")  # creation d'un troisième perso
...
petit_ile.load_map("Data/ile.txt")  # création d'une map "ile" (taille:11/11 ; type "ile")
